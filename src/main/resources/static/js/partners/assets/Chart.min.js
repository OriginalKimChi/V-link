! function(t) {
    ...
    return function o(r, s, l) {
            ...
            function n(t) {
                if (t) {
                    ...
                    if (n) {
                        ...
                        for (n = n[1], a = 0; a < e.length; a++) e[a] = parseInt(n.slice(2 * a, 2 * a + 2), 16);
        ...
        4: [function(t, e, i) {
            ...
            function o(t) {
                var e = t[0],
                    i = t[1],
                    n = t[2];
                return [a(t)[0], 1 / 255 * Math.min(e, Math.min(i, n)) * 100, 100 * (n = 1 - 1 / 255 * Math.max(e, Math.max(i, n)))]
            }
                ...
                e.controllers.bar = e.DatasetController.extend({
                    ...
                    calculateBarIndexPixels: function(t, e, i) {
                        var n, a, o, r, s, l, u, d, c, h, f, g, p, m, v, b, x, y = i.scale.options,
                            k = "flex" === y.barThickness ? (c = e, f = y, m = (p = (h = i).pixels)[c], v = 0 < c ? p[c - 1] : null, b = c < p.length - 1 ? p[c + 1] : null, x = f.categoryPercentage, null === v && (v = m - (null === b ? h.end - m : b - m)), null === b && (b = m + m - v), g = m - (m - v) / 2 * x, {
            ...
            function o(t) {
                ...
                getTitle: function() {
                    var t = this._options.callbacks,
                        ...
                        a = [];
                    return r(a = r(a = r(a, s(e)), s(i)), s(n))
                },
                ...
                update: function(t) {
                    ...
                    if (S.length) {
                        ...
                        var O = [];
                        for (e = 0, i = S.length; e < i; ++e) O.push((b = v = void 0, v = (m = S[e])._xScale, b = m._yScale || m._scale, x = m._index, y = m._datasetIndex, {
                ...
                getCaretPosition: function(t, e, i) {
                    ...
                    else if (n = "left" === c ? (a = f + d + u) - u : "right" === c ? (a = f + p - d - u) - u : (a = i.caretX) - u, o = a + u, "top" === h) s = (r = g) - u, l = r;
                    else {
                        s = (r = g + m) + u, l = r;
                        var v = o;
                        o = n, n = v
        ...
        48: [function(t, e, i) {
            ...
            e.exports = {
                ...
                initialize: function() {
                    ...
                    t = "@-webkit-keyframes " + M + "{" + i + "}@keyframes " + M + "{" + i + "}." + k + "{-webkit-animation:" + M + " 0.001s;animation:" + M + " 0.001s;}", e = this._style || document.createElement("style"), this._style || (t = "/* Chart.js */\n" + t, (this._style = e).setAttribute("type", "text/css"), document.getElementsByTagName("head")[0].appendChild(e)), e.appendChild(document.createTextNode(t))
                },
                ...
                releaseContext: function(t) {
                    ...
                    if (i[x]) {
                        ...
                        ["height", "width"].forEach(function(t) {
                            var e = n[t];
                            b.isNullOrUndef(e) ? i.removeAttribute(t) : i.setAttribute(t, e)
                        }), b.each(n.style || {}, function(t, e) {
                            i.style[e] = t
                        }), i.width = i.width, delete i[x]
                    }
                },
                addEventListener: function(a, t, o) {
                    var e, i, n, r, s, l, u, d, c, h, f, g, p, m = a.canvas;
                    if ("resize" !== t) {
                        var v = o[x] || (o[x] = {});
                        S(m, t, (v.proxies || (v.proxies = {}))[a.id + "_" + t] = function(t) {
                            var e, i, n;
                            o((i = a, _(C[(e = t).type] || e.type, i, (n = b.getRelativePosition(e, i)).x, n.y, e)))
                        })
                    } else i = o, n = a, g = (e = m)[x] || (e[x] = {}), p = g.resizer = function(t) {
                        ...
                        return S(a, "scroll", r.bind(a, "expand")), S(o, "scroll", r.bind(o, "shrink")), e
                    }((l = !(r = function() {
                        if (g.resizer) return i(_("resize", n))
                    }), u = [], function() {
                        u = Array.prototype.slice.call(arguments), s = s || this, l || (l = !0, b.requestAnimFrame.call(window, function() {
                            l = !1, r.apply(s, u)
                        }))
                    })), c = function() {
                        if (g.resizer) {
                    ...
                    }, h = (d = e)[x] || (d[x] = {}), f = h.renderProxy = function(t) {
                        t.animationName === M && c()
                    }, b.each(w, function(t) {
                        S(d, t, f)
                    }), h.reflow = !!d.offsetParent, d.classList.add(k)
                },
                removeEventListener: function(t, e, i) {
                    var n, a, o, r, s, l, u = t.canvas;
                    if ("resize" !== e) {
                        var d = ((i[x] || {}).proxies || {})[t.id + "_" + e];
                        d && c(u, e, d)
                    } else s = (n = u)[x] || {}, l = s.resizer, delete s.resizer, o = (a = n)[x] || {}, (r = o.renderProxy) && (b.each(w, function(t) {
                        c(a, t, r)
                    }), delete o.renderProxy), a.classList.remove(k), l && l.parentNode && l.parentNode.removeChild(l)
                }
            }, b.addEvent = S, b.removeEvent = c
        }, {
            46: 46
        }],
        49: [function(t, e, i) {
        ...
        51: [function(t, e, i) {
            ...
            e.exports = {
                ...
                afterDatasetsUpdate: function(t, e) {
                    ...
                    for (n = 0; n < u; ++n)(o = c[n]) && (o.fill = m(c, n, d), o.boundary = p(o), o.mapper = (l = void 0, !(l = "dataset") === (s = (r = o).fill) ? null : (isFinite(s) || (l = "boundary"), f[l](r))))
                },
            ...
            e.exports = function(e) {
                ...
                var i = e.LinearScaleBase.extend({
                    ...
                    fit: function() {
                        ...
                        }(this) : (this, t = Math.min(this.height / 2, this.width / 2), this.drawingArea = Math.round(t), this.setCenterPoint(0, 0, 0, 0))
                    },
        ...
        59: [function(t, e, i) {
            ...
            function D(t) {
                for (var e = w.indexOf(t) + 1, i = w.length; e < i; ++e)
                    if (M[w[e]].common) return w[e]
            }
            e.exports = function() {
                var t = n.extend({
                    initialize: function() {
                    ...
                    determineDataLimits: function() {
                        var t, e, i, n, a, o, r = this,
                            ...
                            f = [],
                            g = [];
                        for (t = 0, i = s.data.labels.length; t < i; ++t) g.push(_(s.data.labels[t], r));
                        for (t = 0, i = (s.data.datasets || []).length; t < i; ++t)
                            if (s.isDatasetVisible(t))
                                if (a = s.data.datasets[t].data, y.isObject(a[0]))
                                    for (f[t] = [], e = 0, n = a.length; e < n; ++e) o = _(a[e], r), h.push(o), f[t][e] = o;
                                else h.push.apply(h, g), f[t] = g.slice(0);
                            else f[t] = [];
                        g.length && (g = v(g).sort(m), d = Math.min(d, g[0]), c = Math.max(c, g[g.length - 1])), h.length && (h = v(h).sort(m), d = Math.min(d, h[0]), c = Math.max(c, h[h.length - 1])), d = _(l.min, r) || d, c = _(l.max, r) || c, d = d === k ? +x().startOf(u) : d, c = c === p ? +x().endOf(u) + 1 : c, r.min = Math.min(d, c), r.max = Math.max(d + 1, c), r._horizontal = r.isHorizontal(), r._table = [], r._timestamps = {
                            data: h,
                            datasets: f,
                            labels: g
                        }
                    ...
                    buildTicks: function() {
                        ...
                        switch (p.ticks.source) {
                            ...
                            default:
                                v = function(c, h, t, e) {
                                    var i, n = e.time,
                                        f = n.unit || function(t, e, i, n) {
                                            var a, o, r, s = w.length;
                                            for (a = w.indexOf(t); a < s - 1; ++a)
                                                if (r = (o = M[w[a]]).steps ? o.steps[o.steps.length - 1] : k, o.common && Math.ceil((i - e) / (r * o.size)) <= n) return w[a];
                                            return w[s - 1]
                                        }(n.minUnit, c, h, t),
                                        a = D(f),
                                        o = y.valueOrDefault(n.stepSize, n.unitStepSize),
                                        r = "week" === f && n.isoWeekday,
                                        s = e.ticks.major.enabled,
                                        l = M[f],
                                        u = x(c),
                                        d = x(h),
                                        g = [];
                                    for (o || (o = function(t, e, i, n) {
                                        var a, o, r, s = h - c,
                                            l = M[f],
                                            u = l.size,
                                            d = l.steps;
                                        ...
                                        return r
                                    }(0, 0, 0, t)), r && (u = u.isoWeekday(r), d = d.isoWeekday(r)), u = u.startOf(r ? "day" : f), (d = d.startOf(r ? "day" : f)) < h && d.add(1, f), i = x(u), s && a && !r && !n.round && (i.startOf(a), i.add(~~((u - i) / (l.size * o)) * o, f)); i < d; i.add(o, f)) g.push(+i);
                                    return g.push(+i), g
                                }(f, g, h.getLabelCapacity(f), p)
                        }
                        for ("ticks" === p.bounds && v.length && (f = v[0], g = v[v.length - 1]), f = _(m.min, h) || f, g = _(m.max, h) || g, t = 0, e = v.length; t < e; ++t) f <= (i = v[t]) && i <= g && b.push(i);
                        return h.min = f, h.max = g, h._unit = m.unit || function(t, e, i, n) {
                            var a, o, r = x.duration(x(n).diff(x(i)));
                            for (a = w.length - 1; a >= w.indexOf(e); a--)
                                if (o = w[a], M[o].common && r.as(o) >= t.length) return o;
                            return w[e ? w.indexOf(e) : 0]
                        }(b, m.minUnit, h.min, h.max), h._majorUnit = D(h._unit), h._table = function(t, e, i, n) {
                            ...
                            return u
                        }(h._timestamps.data, f, g), h._offsets = (n = h._table, a = b, o = f, r = g, c = d = 0, (s = p).offset && a.length && (s.time.min || (l = 1 < a.length ? a[1] : r, u = a[0], d = (C(n, "time", l, "pos") - C(n, "time", u, "pos")) / 2), s.time.max || (l = a[a.length - 1], u = 1 < a.length ? a[a.length - 2] : o, c = (C(n, "time", l, "pos") - C(n, "time", u, "pos")) / 2)), {
                            left: d,
                            right: c
                        }), h._labelFormat = function(t, e) {
                            var i, n, a, o = t.length;
                            for (i = 0; i < o; i++) {
                                if (0 !== (n = S(t[i], e)).millisecond()) return "MMM D, YYYY h:mm:ss.SSS a";
                    ...
                    getLabelForIndex: function(t, e) {
                        ...
                        return y.isObject(o) && (a = this.getRightValue(o)), n.tooltipFormat ? S(a, n).format(n.tooltipFormat) : "string" == typeof a ? a : S(a, n).format(this._labelFormat)
                    },
                    tickFormatFunction: function(t, e, i, n) {
                        var a = this.options,
                            ...
                            f = t.format(n || (h ? u : s)),
                            g = h ? c : a.ticks.minor,
                            p = y.valueOrDefault(g.callback, g.userCallback);
                        return p ? p(f, e, i) : f
                    },
                    ...
                    getPixelForValue: function(t, e, i) {
                        var n = null;
                        if (void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = _(t, this)), null !== n) return this.getPixelForOffset(n)
                    },
                    getPixelForTick: function(t) {
                        var e = this.getTicks();
                    ...
                    getValueForPixel: function(t) {
                        var e = this,
                            ...
                            o = C(e._table, "pos", a, "time");
                        return x(o)
                    },
                    getLabelWidth: function(t) {
                        var e = this.options.ticks,
                            i = this.ctx.measureText(t).width,
                            n = y.toRadians(e.maxRotation),
                            a = Math.cos(n),
                            o = Math.sin(n);
                        return i * a + y.valueOrDefault(e.fontSize, r.global.defaultFontSize) * o
                    },
